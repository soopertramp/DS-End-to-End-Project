...
def generate_forecasts(df: pd.DataFrame, cities: List[str], product_lines: List[str]) -> pd.DataFrame:
    ...
    for city in cities:
        for product_line in product_lines:
            ...
            forecasts.append(forecast[['city', 'product_line', 'ds', 'yhat', 'yhat_lower', 'yhat_upper']])
...
predictions = prediction[['ds', 'yhat', 'yhat_lower', 'yhat_upper']]

predictions1 = cross_validation(predictions, initial='730 days', period='180 days', horizon = '365 days')